	        ...
	        onMenuItemSelect: function onMenuItemSelect(e) {
	            ...
	            if (elementType === 'menuitem') {
	                ...
	                if ((!element.pageDoc || element.getAttribute(menuItemReloadAttribute)) && page) {
	                    ...
	                    // Page loaded
	                    var pageLoaded = function pageLoaded(doc) {
	                    ...
	                    return _navigation2.default.getLoaderDoc(_menu2.default.getLoadingMessage()).then(loading).then(loadPage).then(pageLoaded).catch(error);
	                }
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function create() {
	    ...
	    if (!!defaults.template) {
	        ...
	        docStr = _lodash2.default.isFunction(defaults.template) ? defaults.template() : defaults.template;
	    }
